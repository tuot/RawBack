...
`;function D(e,t){let n=e.platform===`gist`;return{platformInitials:A(e.platform),platformLabel:k(e.platform),repositoryLabel:`${e.user} / ${e.repo}`,filePath:e.filePath,primaryActionLabel:T(n?`openInGist`:`openInRepository`,t),primaryActionAriaLabel:T(n?`openGistFileAriaLabel`:`openRepositoryFileAriaLabel`,t),primaryActionUrl:e.fileUrl,repositoryOrigin:O(e.fileUrl)}}function O(e){try{return new URL(e).origin}catch{return``}}function k(e){return e===`github`?`GitHub`:e===`gitlab`?`GitLab`:e===`gitea`?`Gitea`:e===`gist`?`GitHub Gist`:``}function A(e){return e===`github`?`GH`:e===`gitlab`?`GL`:e===`gitea`?`GT`:e===`gist`?`GH`:``}function j(e,t){let n=t===`dark`;return e===`github`||e===`gist`?`<svg viewBox="0 0 16 16" width="14" height="14" fill="${n?`#E6EDF3`:`#1F2328`}" aria-hidden="true"><path d="M8 0c4.42 0 8 3.58 8 8a8.013 8.013 0 0 1-5.45 7.59c-.4.08-.55-.17-.55-.38 0-.27.01-1.13.01-2.2 0-.75-.25-1.23-.54-1.48 1.78-.2 3.65-.88 3.65-3.95 0-.88-.31-1.59-.82-2.15.08-.2.36-1.02-.08-2.12 0 0-.67-.22-2.2.82-.64-.18-1.32-.27-2-.27-.68 0-1.36.09-2 .27-1.53-1.03-2.2-.82-2.2-.82-.44 1.1-.16 1.92-.08 2.12-.51.56-.82 1.28-.82 2.15 0 3.06 1.86 3.75 3.64 3.95-.23.2-.44.55-.51 1.07-.46.21-1.61.55-2.33-.66-.15-.24-.6-.83-1.23-.82-.67.01-.27.38.01.53.34.19.73.9.82 1.13.16.45.68 1.31 2.69.94 0 .67.01 1.3.01 1.49 0 .21-.15.45-.55.38A7.995 7.995 0 0 1 0 8c0-4.42 3.58-8 8-8Z"></path></svg>`:e===`gitlab`?`<svg viewBox="0 0 16 16" width="14" height="14" fill="none" aria-hidden="true" style="margin-top: 4px;"><path fill="#E24329" d="M15.82 5.922 13.57.172a.548.548 0 0 0-1.024 0L10.74 4.802H5.26L3.456.17a.548.548 0 0 0-1.024 0L.182 5.922c-.173.44.025.932.44 1.114l7.38 5.753 7.378-5.75c.415-.183.614-.675.44-1.116Z"/><path fill="#FC6D26" d="M10.74 4.802 8 13.256l7.378-6.22-4.638-2.234Z"/><path fill="#FCA326" d="M8 13.256 10.74 4.802h4.639L8 13.256Z"/><path fill="#FC6D26" d="M5.26 4.802 8 13.256.622 7.036 5.26 4.802Z"/><path fill="#FCA326" d="M8 13.256 5.26 4.802H.621L8 13.256Z"/></svg>`:e===`gitea`?`<svg viewBox="0 0 24 24" width="14" height="14" fill="${n?`#84D637`:`#609926`}" aria-hidden="true"><path d="M4.209 4.603c-.247 0-.525.02-.84.088-.333.07-1.28.283-2.054 1.027C-.403 7.25.035 9.685.089 10.052c.065.446.263 1.687 1.21 2.768 1.749 2.141 5.513 2.092 5.513 2.092s.462 1.103 1.168 2.119c.955 1.263 1.936 2.248 2.89 2.367 2.406 0 7.212-.004 7.212-.004s.458.004 1.08-.394c.535-.324 1.013-.893 1.013-.893s.492-.527 1.18-1.73c.21-.37.385-.729.538-1.068 0 0 2.107-4.471 2.107-8.823-.042-1.318-.367-1.55-.443-1.627-.156-.156-.366-.153-.366-.153s-4.475.252-6.792.306c-.508.011-1.012.023-1.512.027v4.474l-.634-.301c0-1.39-.004-4.17-.004-4.17-1.107.016-3.405-.084-3.405-.084s-5.399-.27-5.987-.324c-.187-.011-.401-.032-.648-.032zm.354 1.832h.111s.271 2.269.6 3.597C5.549 11.147 6.22 13 6.22 13s-.996-.119-1.641-.348c-.99-.324-1.409-.714-1.409-.714s-.73-.511-1.096-1.52C1.444 8.73 2.021 7.7 2.021 7.7s.32-.859 1.47-1.145c.395-.106.863-.12 1.072-.12zm8.33 2.554c.26.003.509.127.509.127l.868.422-.529 1.075a.686.686 0 0 0-.614.359.685.685 0 0 0 .072.756l-.939 1.924a.69.69 0 0 0-.66.527.687.687 0 0 0 .347.763.686.686 0 0 0 .867-.206.688.688 0 0 0-.069-.882l.916-1.874a.667.667 0 0 0 .237-.02.657.657 0 0 0 .271-.137 8.826 8.826 0 0 1 1.016.512.761.761 0 0 1 .286.282c.073.21-.073.569-.073.569-.087.29-.702 1.55-.702 1.55a.692.692 0 0 0-.676.477.681.681 0 1 0 1.157-.252c.073-.141.141-.282.214-.431.19-.397.515-1.16.515-1.16.035-.066.218-.394.103-.814-.095-.435-.48-.638-.48-.638-.467-.301-1.116-.58-1.116-.58s0-.156-.042-.27a.688.688 0 0 0-.148-.241l.516-1.062 2.89 1.401s.48.218.583.619c.073.282-.019.534-.069.657-.24.587-2.1 4.317-2.1 4.317s-.232.554-.748.588a1.065 1.065 0 0 1-.393-.045l-.202-.08-4.31-2.1s-.417-.218-.49-.596c-.083-.31.104-.691.104-.691l2.073-4.272s.183-.37.466-.497a.855.855 0 0 1 .35-.077z"/></svg>`:``}function M(e){return e===`github`||e===`gist`?`<svg viewBox="0 0 16 16" width="14" height="14" fill="currentColor" aria-hidden="true"><path d="M8 0c4.42 0 8 3.58 8 8a8.013 8.013 0 0 1-5.45 7.59c-.4.08-.55-.17-.55-.38 0-.27.01-1.13.01-2.2 0-.75-.25-1.23-.54-1.48 1.78-.2 3.65-.88 3.65-3.95 0-.88-.31-1.59-.82-2.15.08-.2.36-1.02-.08-2.12 0 0-.67-.22-2.2.82-.64-.18-1.32-.27-2-.27-.68 0-1.36.09-2 .27-1.53-1.03-2.2-.82-2.2-.82-.44 1.1-.16 1.92-.08 2.12-.51.56-.82 1.28-.82 2.15 0 3.06 1.86 3.75 3.64 3.95-.23.2-.44.55-.51 1.07-.46.21-1.61.55-2.33-.66-.15-.24-.6-.83-1.23-.82-.67.01-.27.38.01.53.34.19.73.9.82 1.13.16.45.68 1.31 2.69.94 0 .67.01 1.3.01 1.49 0 .21-.15.45-.55.38A7.995 7.995 0 0 1 0 8c0-4.42 3.58-8 8-8Z"></path></svg>`:e===`gitlab`?`<svg viewBox="0 0 16 16" width="14" height="14" fill="none" aria-hidden="true" style="margin-top: 4px;"><path fill="currentColor" d="M15.82 5.922 13.57.172a.548.548 0 0 0-1.024 0L10.74 4.802H5.26L3.456.17a.548.548 0 0 0-1.024 0L.182 5.922c-.173.44.025.932.44 1.114l7.38 5.753 7.378-5.75c.415-.183.614-.675.44-1.116Z"/><path fill="currentColor" d="M10.74 4.802 8 13.256l7.378-6.22-4.638-2.234Z"/><path fill="currentColor" d="M8 13.256 10.74 4.802h4.639L8 13.256Z"/><path fill="currentColor" d="M5.26 4.802 8 13.256.622 7.036 5.26 4.802Z"/><path fill="currentColor" d="M8 13.256 5.26 4.802H.621L8 13.256Z"/></svg>`:e===`gitea`?`<svg viewBox="0 0 24 24" width="14" height="14" fill="currentColor" aria-hidden="true"><path d="M4.209 4.603c-.247 0-.525.02-.84.088-.333.07-1.28.283-2.054 1.027C-.403 7.25.035 9.685.089 10.052c.065.446.263 1.687 1.21 2.768 1.749 2.141 5.513 2.092 5.513 2.092s.462 1.103 1.168 2.119c.955 1.263 1.936 2.248 2.89 2.367 2.406 0 7.212-.004 7.212-.004s.458.004 1.08-.394c.535-.324 1.013-.893 1.013-.893s.492-.527 1.18-1.73c.21-.37.385-.729.538-1.068 0 0 2.107-4.471 2.107-8.823-.042-1.318-.367-1.55-.443-1.627-.156-.156-.366-.153-.366-.153s-4.475.252-6.792.306c-.508.011-1.012.023-1.512.027v4.474l-.634-.301c0-1.39-.004-4.17-.004-4.17-1.107.016-3.405-.084-3.405-.084s-5.399-.27-5.987-.324c-.187-.011-.401-.032-.648-.032zm.354 1.832h.111s.271 2.269.6 3.597C5.549 11.147 6.22 13 6.22 13s-.996-.119-1.641-.348c-.99-.324-1.409-.714-1.409-.714s-.73-.511-1.096-1.52C1.444 8.73 2.021 7.7 2.021 7.7s.32-.859 1.47-1.145c.395-.106.863-.12 1.072-.12zm8.33 2.554c.26.003.509.127.509.127l.868.422-.529 1.075a.686.686 0 0 0-.614.359.685.685 0 0 0 .072.756l-.939 1.924a.69.69 0 0 0-.66.527.687.687 0 0 0 .347.763.686.686 0 0 0 .867-.206.688.688 0 0 0-.069-.882l.916-1.874a.667.667 0 0 0 .237-.02.657.657 0 0 0 .271-.137 8.826 8.826 0 0 1 1.016.512.761.761 0 0 1 .286.282c.073.21-.073.569-.073.569-.087.29-.702 1.55-.702 1.55a.692.692 0 0 0-.676.477.681.681 0 1 0 1.157-.252c.073-.141.141-.282.214-.431.19-.397.515-1.16.515-1.16.035-.066.218-.394.103-.814-.095-.435-.48-.638-.48-.638-.467-.301-1.116-.58-1.116-.58s0-.156-.042-.27a.688.688 0 0 0-.148-.241l.516-1.062 2.89 1.401s.48.218.583.619c.073.282-.019.534-.069.657-.24.587-2.1 4.317-2.1 4.317s-.232.554-.748.588a1.065 1.065 0 0 1-.393-.045l-.202-.08-4.31-2.1s-.417-.218-.49-.596c-.083-.31.104-.691.104-.691l2.073-4.272s.183-.37.466-.497a.855.855 0 0 1 .35-.077z"/></svg>`:``}var N=`rawback-banner-host`;function P(e,t){F();let n=document.createElement(`div`);n.id=N,n.dataset.theme=I(t.theme);let r=document.createElement(`style`);r.textContent=E;let i=document.createElement(`div`),a=t=>{let n=D(e,t.language);i.className=`rawback-banner`,i.setAttribute(`role`,`region`),i.setAttribute(`aria-label`,T(`bannerAriaLabel`,t.language));let r=I(t.theme),a=j(e.platform,r),o=M(e.platform);i.innerHTML=`
      <div class="rawback-mark" aria-hidden="true">
        <span class="rawback-mark-icon-wrapper">${a}</span>
        <span class="rawback-mark-fallback" style="display:none;">${L(n.platformInitials)}</span>
      </div>
      <div class="rawback-meta">
        <span class="rawback-title">${L(n.repositoryLabel)}</span>
        <span class="rawback-path">${L(n.filePath)}</span>
      </div>
      <div class="rawback-actions">
        <div class="rawback-open-actions">
          <a class="rawback-button primary" href="${R(n.primaryActionUrl)}" aria-label="${R(n.primaryActionAriaLabel)}">
            ${o}
            ${L(n.primaryActionLabel)}
          </a>
        </div>
      </div>
    `};return a(t),n.dataset.mounted=`true`,n.append(r,i),document.body.prepend(n),{remove:()=>{n.remove()},update:e=>{n.dataset.theme=I(e.theme),a(e)}}}function F(){document.getElementById(N)?.remove()}function I(e){return e===`light`||e===`dark`?e:matchMedia(`(prefers-color-scheme: dark)`).matches?`dark`:`light`}function L(e){return e.replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e])}function R(e){return L(e)}var z=e({matches:[`<all_urls>`],runAt:`document_start`,async main(){let e=null,t=null,n=null,r=async r=>{let a=r??await _(),o=i(location.href,{disabledPlatforms:a.disabledPlatforms,selfHostedGitlabHosts:a.selfHostedGitlabHosts,selfHostedGiteaHosts:a.selfHostedGiteaHosts}),s=!a.enabled||a.disabledHosts.includes(location.hostname)||!o||a.dismissedFiles.includes(o.fileUrl),c=V(a,o);if(document.documentElement.dataset.rawbackLoaded=`true`,document.documentElement.dataset.rawbackReason=c,s){e?.remove(),e=null,t=null,n=null,F();return}if(e&&t===o.fileUrl&&n===a.language){e.update(a);return}await B(),e?.remove(),e=P(o,a),t=o.fileUrl,n=a.language};await r(),v(e=>void r(e))}});function B(){return document.body?Promise.resolve():new Promise(e=>{let t=new MutationObserver(()=>{document.body&&(t.disconnect(),e())});t.observe(document.documentElement,{childList:!0})})}function V(e,t){return e.enabled?e.disabledHosts.includes(location.hostname)?`disabled-host`:t?e.dismissedFiles.includes(t.fileUrl)?`dismissed-file`:`visible`:`not-raw-url`:`disabled`}var H={debug:(...e)=>([...e],void 0),log:(...e)=>([...e],void 0),warn:(...e)=>([...e],void 0),error:(...e)=>([...e],void 0)},U=class e extends Event{static EVENT_NAME=W(`wxt:locationchange`);constructor(t,n){super(e.EVENT_NAME,{}),this.newUrl=t,this.oldUrl=n}};function W(e){return`${m?.runtime?.id}:content:${e}`}var G=typeof globalThis.navigation?.addEventListener==`function`;function K(e){let t,n=!1;return{run(){n||(n=!0,t=new URL(location.href),G?globalThis.navigation.addEventListener(`navigate`,e=>{let n=new URL(e.destination.url);n.href!==t.href&&(window.dispatchEvent(new U(n,t)),t=n)},{signal:e.signal}):e.setInterval(()=>{let e=new URL(location.href);e.href!==t.href&&(window.dispatchEvent(new U(e,t)),t=e)},1e3))}}}var q=class e{static SCRIPT_STARTED_MESSAGE_TYPE=W(`wxt:content-script-started`);id;abortController;locationWatcher=K(this);constructor(e,t){this.contentScriptName=e,this.options=t,this.id=Math.random().toString(36).slice(2),this.abortController=new AbortController,this.stopOldScripts(),this.listenForNewerScripts()}get signal(){return this.abortController.signal}abort(e){return this.abortController.abort(e)}get isInvalid(){return m.runtime?.id??this.notifyInvalidated(),this.signal.aborted}get isValid(){return!this.isInvalid}onInvalidated(e){return this.signal.addEventListener(`abort`,e),()=>this.signal.removeEventListener(`abort`,e)}block(){return new Promise(()=>{})}setInterval(e,t){let n=setInterval(()=>{this.isValid&&e()},t);return this.onInvalidated(()=>clearInterval(n)),n}setTimeout(e,t){let n=setTimeout(()=>{this.isValid&&e()},t);return this.onInvalidated(()=>clearTimeout(n)),n}requestAnimationFrame(e){let t=requestAnimationFrame((...t)=>{this.isValid&&e(...t)});return this.onInvalidated(()=>cancelAnimationFrame(t)),t}requestIdleCallback(e,t){let n=requestIdleCallback((...t)=>{this.signal.aborted||e(...t)},t);return this.onInvalidated(()=>cancelIdleCallback(n)),n}addEventListener(e,t,n,r){t===`wxt:locationchange`&&this.isValid&&this.locationWatcher.run(),e.addEventListener?.(t.startsWith(`wxt:`)?W(t):t,n,{...r,signal:this.signal})}notifyInvalidated(){this.abort(`Content script context invalidated`),H.debug(`Content script "${this.contentScriptName}" context invalidated`)}stopOldScripts(){document.dispatchEvent(new CustomEvent(e.SCRIPT_STARTED_MESSAGE_TYPE,{detail:{contentScriptName:this.contentScriptName,messageId:this.id}})),this.options?.noScriptStartedPostMessage||window.postMessage({type:e.SCRIPT_STARTED_MESSAGE_TYPE,contentScriptName:this.contentScriptName,messageId:this.id},`*`)}verifyScriptStartedEvent(e){let t=e.detail?.contentScriptName===this.contentScriptName,n=e.detail?.messageId===this.id;return t&&!n}listenForNewerScripts(){let t=e=>{!(e instanceof CustomEvent)||!this.verifyScriptStartedEvent(e)||this.notifyInvalidated()};document.addEventListener(e.SCRIPT_STARTED_MESSAGE_TYPE,t),this.onInvalidated(()=>document.removeEventListener(e.SCRIPT_STARTED_MESSAGE_TYPE,t))}},J={debug:(...e)=>([...e],void 0),log:(...e)=>([...e],void 0),warn:(...e)=>([...e],void 0),error:(...e)=>([...e],void 0)};return(async()=>{try{let{main:e,...t}=z;return await e(new q(`content`,t))}catch(e){throw J.error(`The content script "content" crashed on startup!`,e),e}})()})();
content;